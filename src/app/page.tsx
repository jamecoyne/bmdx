            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox id="identity" defaultChecked />
                  <Label htmlFor="identity" className="text-bm-white">Identity</Label>
                </div>
                <div className="flex items-center space-x-3">
                  <Checkbox id="content" />
                  <Label htmlFor="content" className="text-bm-white">Content</Label>
                </div>
                <div className="flex items-center space-x-3">
                  <Checkbox id="tech" />
                  <Label htmlFor="tech" className="text-bm-white">Creative Technology</Label>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <RadioGroup defaultValue="boston">
                  <div className="flex items-center space-x-3">
                    <RadioGroupItem value="boston" id="boston" />
                    <Label htmlFor="boston" className="text-bm-white">Boston</Label>
                  </div>
                  <div className="flex items-center space-x-3">
                    <RadioGroupItem value="nyc" id="nyc" />
                    <Label htmlFor="nyc" className="text-bm-white">New York</Label>
                  </div>
                  <div className="flex items-center space-x-3">
                    <RadioGroupItem value="portland" id="portland" />
                    <Label htmlFor="portland" className="text-bm-white">Portland</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
          ...
          <Section title="Switch">
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <Label htmlFor="dark-mode" className="text-bm-white">Dark Mode</Label>
              </div>
              <div className="flex items-center space-x-3">
                <Switch id="notifications" />
                <Label htmlFor="notifications" className="text-bm-white">Notifications</Label>
              </div>
            </div>
          </Section>
